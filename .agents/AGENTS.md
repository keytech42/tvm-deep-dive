...
- **[ ] Step 4A: C++ Core - Operator Fusion**: Zoom in on `src/relax/transform`. Goal: Trace graph-level pattern matching and TensorIR instruction generation (`fuse_ops.cc`, `fuse_tir.cc`).
